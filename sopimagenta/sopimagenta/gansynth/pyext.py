...
class gansynth(pyext._class):
    def __init__(self, out_buf_name, redundancy=0, batch_size=8, gpu_memory_fraction=0.0, sample_rate=16000, gen_dur=4):
        self._inlets = 1
        self._outlets = 1
        self._proc = None
    ...
    def load_1(self, ckpt_dir):
        ...
        print(f"sample_rate={self.sample_rate}, gen_dur={self.gen_dur}, batch_size={self.batch_size}, redundancy={self.redundancy}, gpu_memory_fraction={self.gpu_memory_fraction}")
        ...
        worker_cmd = (python, gen_script, ckpt_dir, str(self.batch_size), str(self.gpu_memory_fraction))
