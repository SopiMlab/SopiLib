...
#         return len(self.pca["comp"])

#     def synthesize(zs, pitches, edits=None):
#         assert zs == None or len(zs) == len(pitches), "number of zs doesn't match number of pitches"
#         assert edits == None or len(edits) == len(pitches), "number of edits doesn't match number of pitches"
...
#             if edits != None:
#                 sound_edits = edits[i]
#                 max_num_edits = max(max_num_edits, len(sound_edits))

#             sounds.append(SimpleNamespace(
#                 pitch = pitch,
#                 edits = sound_edits
#             ))
...
#                 if zs != None:
#                     audios = model.generate_samples_from_z(np.array(zs), pitches, layer_offsets=layer_offsets)
